...
public class WebService_GetSA_Login {
    ...
    public WSResult login(Context context, String soapmethod, String soapAddress, String user, String pwd) {
...
//        }
        return (WebService_GetSA_Login.WSResult) WSResult;
    }
