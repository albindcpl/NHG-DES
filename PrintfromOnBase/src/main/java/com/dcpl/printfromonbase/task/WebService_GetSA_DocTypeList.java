...
public class WebService_GetSA_DocTypeList {
    ...
    public  WebService_GetSA_DocTypeList.WSResult get(String soapmethod, String soapAddress, String sessionID,String doctype){
        ...
        try{
            ...
            PropertyInfo propdoctype = new PropertyInfo();
            ...
            propdoctype.setName("dtg");
            propdoctype.setValue(docType);
            propdoctype.setType(String.class);

            request.addProperty(propsessionID);
            request.addProperty(propdoctype);
...
//            }
        ...
        WebService_GetSA_DocTypeList.WSResult wsResult1 = new  WebService_GetSA_DocTypeList.WSResult();
