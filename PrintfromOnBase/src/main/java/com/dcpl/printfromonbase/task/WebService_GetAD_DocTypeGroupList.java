...
public class WebService_GetAD_DocTypeGroupList {
  ...
  //  @SuppressLint("LongLogTag")
    public WebService_GetAD_DocTypeGroupList.WSResult get(String soapmethod, String soapAddress, String sessionID){
...
//            Log.e(TAG, "Exception: " + ex);
        ...
        WebService_GetAD_DocTypeGroupList.WSResult wsResult1 = new WebService_GetAD_DocTypeGroupList.WSResult();
