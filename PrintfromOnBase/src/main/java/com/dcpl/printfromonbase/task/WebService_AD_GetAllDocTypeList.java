...
public class WebService_AD_GetAllDocTypeList {
   ...
   // @SuppressLint("LongLogTag")
    public WebService_AD_GetAllDocTypeList.WSResult get(String soapmethod, String soapAddress, String sessionID){
...
//            }
        ...
        WebService_AD_GetAllDocTypeList.WSResult wsResult1 = new WebService_AD_GetAllDocTypeList.WSResult();
    ...
    public class WSResult{
        ...
        public ArrayList getAlldoctypelist() {
            return doctypelist;
        }
