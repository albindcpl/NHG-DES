...
public class WebService_GetSA_KeywordList {
    ...
    public WebService_GetSA_KeywordList.WSResult get(String soapmethod, String soapAddress, String sessionID, String doctype){
        ...
        WebService_GetSA_KeywordList.WSResult wsResult1 = new WSResult();
...
//                KeywordNameList = soapResponse.getProperty("kwnamelist").toString();
//                Log.d(TAG,"keywordnameList"+KeywordNameList);
//                KeywordDatatypeList = soapResponse.getProperty("kwdatatypelist").toString();
//                Log.d(TAG,"keyworddatatypelist"+KeywordDatatypeList);
//                KeywordDetailList = soapResponse.getProperty("kwdetaillist").toString();
//                Log.d(TAG,"keyworddatatypelist"+KeywordDetailList);
