...
public class WebService_GetSA_Document {
...
//    public void WebService_GetSA_Document(Context context){
//        this.context = context;
//        FILE_PATH =  new File(context.getFilesDir() + "/");
//    }

    public WebService_GetSA_Document.WSResult document(Context context,String soapMethod, String soapAddress, String sessionID, long docid){

        WebService_GetSA_Document.WSResult wsResult = new WebService_GetSA_Document.WSResult();
        FILE_PATH =  new File(context.getFilesDir() + "/");
